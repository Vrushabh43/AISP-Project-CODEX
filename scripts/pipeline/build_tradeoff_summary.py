...
execute official BackdoorLLM code, call APIs, or update submission artifacts.
"""
...
FINAL_LOGS_DIR = ROOT / "logs" / "audit"
...
DEFAULT_SIMILARITY = FINAL_RESULTS_DIR / "clean_behaviour_similarity_summary.csv"
DEFAULT_OUTPUT = FINAL_RESULTS_DIR / "official_rule_based_asr_clean_tradeoff_summary.csv"
DEFAULT_LOGS_DIR = FINAL_LOGS_DIR
DEFAULT_FIGURE = ROOT / "reports" / "figures" / "official_rule_based_asr_clean_tradeoff.png"
FOCUSED_CONDITIONS = [
    "base_model_only",
    "original",
    "uniform_gamma_0.25",
        ...
        rows.append(
            {
                ...
                "notes": "Submission summary; preserve the stated caveats when reporting.",
            }
        )
    metadata = {
